                    ...
                    <div className="footer-links">
                      <div className="footer-row">
                        <ul className="align-items-center">
                          ...
                          <li className="li">
                            <a className="single-link" href="/divanbed/suede-Fabric-Divan-Beds">
                              Suede Divan Bed
                            </a>
                          </li>
                          <li className="li">
                          ...
                          <li className="li">
                            <a className="single-link" href="/product/Mattressess">
                              Mattressess
                            </a>
                          </li>
                          <li className="li">
                            <a className="single-link" href="/divanbed/velvet-Fabric-Divan-Beds">
                              Velvet Fabric Diven Beds
                            </a>
                          </li>
                          <li className="li">
                            <a className="single-link" href="/allbed/sleigh-beds">
                              Sleigh Beds
                            </a>
                          </li>
                        </ul>
