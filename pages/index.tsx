          ...
          <div className="row">
            ...
            <div className={`${styles.mwfull} col-7`}>
              <div className={styles.dreambedcontent}>
                ...
                <p>
                  We are one of the UK’s largest manufacturers of cheap beds for
                  sale online and suppliers of top brands. With an enormous
                  selection of affordable beds, bed frames, headboards, and
                  mattresses — to suit just about every style, purpose and taste
                  ...
                  <ul>
                    <li>
                      <p>
                        ...
                        The UK’s largest selection of cheap divan beds
                      </p>
                    </li>
                    <li>
                      <p>
                        <RightIcon size={40} color="#222178" />
                        Cheap small double and double beds with mattresses
                      </p>
                    </li>
                    <li>
                      <p>
                        <RightIcon size={40} color="#222178" />
                        Cheap king size and super king size beds
                      </p>
                    </li>
                  </ul>
                </div>
            ...
            <div className={`${styles.mwfull} col-6`}>
              <div className={styles.onemattressscontent1}>
                ...
                <p>
                  ...
                  plenty of fantastic deals and sales on. So, from traditional
                  spring, to memory foam or orthopaedic mattresses, make sure to
                  view our range today. And if you can’t find what you’re
