      ...
      return (
        <>
          <div className={css.paymentparagraph}>
            <p>
              Your personal data will be used to process your order,<br></br>
              support your experience throughout this website, and for<br></br>
      ...
      <div className={css["summary-container"]}>
        <div className={css["summary-items"]}>
          ...
          <ul>
            ...
            <li>
              <span>Storage </span>
              <span>:</span>
              <span>{accessories?.storage?.name}</span>
            </li>
            <li>
              <span>Headboard </span>
              <span>:</span>
              <span>{accessories?.headboard?.name}</span>
            </li>
            <li>
              <span>Feet </span>
              <span>:</span>
              <span>{accessories?.feet?.name}</span>
            </li>
            <li>
              <span>Mattressess </span>
              <span>:</span>
              <span>{accessories?.mattress?.name}</span>
            </li>
          </ul>
        </div>
        ...
        <div className={css["price-summary1"]}>
          <h5>
            ...
            <span className={css["price-sums1"]}>
              Free<br></br>shipping
            </span>
          </h5>
        </div>
