                            ...
                            {haveSomethingInCart ? (
                                <div className={css["summary"]}>
                                    ...
                                    <TotalSummary
                                        ...
                                        onCodCheckout={createCheckOutSession}
            ...
            <div className={css.items}>
                ...
                <div>
                    <PaymentButton
                        ...
                        disable={isDisable}
                        onCashOnDelivery={onCheckout}
                        onStripeCheckout={onCodCheckout}
                ...
                <div className={css.first_boxcart}>
                    <div className={css.item3}>
                        ...
                        >
                            ...
                            <p>
                                For peace of mind, add this to your order today
                                – we’ll collect and recycle your old bed during
                                the delivery of your new bed.
                            </p>
                            <ul className={css.boxfirst_cartul}>
                                <li>
                                    All recyclable materials are reused, and
                                    waste is turned into green energy
                                </li>
                                <li>
                                    Ensure you have dismantled any furniture
                                    items prior to delivery
                                </li>
                                <li>
                                    We’ll provide you with a green bag to wrap
                                    your item in before delivery
                                </li>
                                <li>
                                    All recyclable materials are reused, and
                                    waste is turned into green energy
                        ...
                        >
                            ...
                            <ul className={css.boxfirst_cartul}>
                                <li>
                                    Our team are fully trained in bed building
                                </li>
                                <li>
                                    We offer a quick and tidy service – all
                                    packaging is taken away
                                </li>
                            </ul>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <p>
                                Be rest assured by adding insurance to your
                                purchase. We’ll then provide:
                            </p>
                            <ul className={css.boxfirst_cartul}>
                                ...
                                <li>
                                    A FREE mattress protector with each mattress
                                    added to the service plan
                                </li>
                            </ul>
                        </div>
                    </div>
