...
const SmallDouble40: NextPageWithLayout = () => {
        ...
        <div className={` ${styles.section_first} container-fluid`}>
          <div className="row">
            <div className="col-12">
              <h1 className={styles.headingh1}>Small Double (4"0)</h1>
            </div>
          </div>
        </div>
...
export default SmallDouble40;

SmallDouble40.getLayout = PerPageLayout;
