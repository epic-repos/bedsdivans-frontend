...
const LinenFabric: NextPageWithLayout = () => {
  const { data } = useFetchAllBedsWithImage("Linen-fabric");
  return (
    <>
      <div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h1 className={styles.headingh1}>LINEN FABRIC DIVAN BEDS</h1>
...
LinenFabric.getLayout = PerPageLayout;
