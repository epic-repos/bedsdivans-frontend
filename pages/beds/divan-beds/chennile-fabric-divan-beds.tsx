...
const ChennileFabric: NextPageWithLayout = () => {
  const { data } = useFetchAllBedsWithImage("Chenille-fabric");
  return (
    <>
      <div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h1 className={styles.headingh1}>CHENNILE FABRIC DIVAN BEDS</h1>
...
export default ChennileFabric;

ChennileFabric.getLayout = PerPageLayout;
