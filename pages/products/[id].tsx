  ...
  return (
    <div className={Styles.desctab3}>
      ...
      <p>
        ...
        24-48 hours of receiving your delivery.<br></br>Reported faults will
        result in a dispute claim which require photographic evidence for our
        friendly after sales team to resolve the issue.
      </p>
      <h5>Refunds</h5>
      <p>
