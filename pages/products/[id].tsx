...
const NewProductPage = () => {
  ...
  const [style, setStyle] = React.useState<React.CSSProperties>({
    backgroundImage: `url(${state?.color?.image || data?.variants[0]?.image})`,
            ...
            <div className={css["image-section"]}>
              <div className={css["product-image"]}>
                ...
                >
                  <img
                    className={css["image"]}
                    src={state?.color?.image || data?.variants[0]?.image}
                    alt="Grey-linen"
                  />
                </figure>
              </div>
            ...
            return (
              <>
                ...
                <option
                  key={index}
                  value={
                    type === "accessories" ? JSON.stringify(data) : data.value
                  }
                >
...
const PolicyWarranty = () => {
  return (
    <div className={Styles.desctab3}>
      ...
      <p>Standard Free Delivery is within 3-5 working days within 120 miles of our postcode WV14 7HZ, any orders placed outside this postcode will take slightly longer.  Areas covered within 2-5 working days are London, East Midlands, West Midlands, South Wales, Manchester, Yorkshire, and surrounding postcodes.Orders will only be dispatched once the order has been confirmed with the customer and the delivery date / approximate time has been given.</p>
      <p>Safe Delivery All orders are delivered to the front of the building via our free standard kerbside delivery. If you live in a flat, it will be delivered to the communal entrance of the building. Couriers may deliver to the hallway at their own discretion.</p>
      ...
      <p>Missed Delivery All customers are contacted regarding the delivery date/ time frame.  Once the delivery is confirmed and booked in, the driver will contact you prior to delivery and if the delivery is missed, you are liable for the courier charge for the following booking</p>
       <p>Delivery Professionals Our friendly delivery drivers adhere to strict health and safety standards, to ensure your order is delivered in an efficient and professional manner. This ensures minimum damage that can be caused by mainstream couriers due to changing hands too many times.</p>
       <p>Refusal of Delivery If you refuse to accept a delivery on the day without approval from us, a charge of £62 will be liable to be paid. The amount will be debited from any refunds due paid by card or any other means.</p>
       <h5> Warranty</h5>
       <p>Garden Furniture The colour of wooden furniture is affected eventually by UV rays and is not covered by our guarantee. Therefore, you the customer are responsible to maintain and treat the equipment.</p>
       ...
       <p>Our 2-year structural guarantee does not cover the normal wear and tear of furniture or any damages that arise due to misuse, negligence, or incorrect assembly.<br></br>Beds / Mattresses You will receive a full 1 Year Exchange Guarantee with a full bed set (like for like).</p>
       <h5>Refunds, Returns and Exchanges</h5>
       <p>Changing your order You can make any changes within 48 hours of placing your order, such as colour, bed size and quantity.</p>
       <p>Cancelling your order if you wish to cancel your order please either call or email us and we can get this done for you.</p>
       ...
       <p>What if my item doesn’t fit? It is your responsibility to make sure you carefully check the measurements before placing your order. If the item has been delivered and does not fit, you are liable for returning the item back or arranging collection subject to a courier charge of £62 in its original condition and in its original packaging, for a refund to be processed.</p>
       <p>Faulty products Our products are handled with care and usually arrive in good condition. If your item is faulty this must be reported within 24-48 hours of receiving your delivery.<br></br>Reported faults will result in a dispute claim which require photographic evidence for our friendly after sales team to resolve the issue.</p>
       <h5>Refunds</h5>
